...
CONSUMER_KEY    = 'bf519f96562d40a9a6948b6f3ec438c0'
CONSUMER_SECRET = 'fcb0a4474e884e37b8fdb2677939aff0'
...
def fetch_response(oauth_request, connection, debug=DEBUG):
   ...
   print oauth_request.http_method, url
